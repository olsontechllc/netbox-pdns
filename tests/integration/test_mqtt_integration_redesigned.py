...
class TestMQTTIntegrationEndToEnd:
    ...
    def test_mqtt_status_endpoint_disabled(self, mock_netbox_api):
    ...
    def test_mqtt_status_endpoint_enabled_structure(self, mock_netbox_api):
    ...
    def test_app_startup_mqtt_disabled(self, mock_netbox_api):
    ...
    def test_app_startup_mqtt_enabled_observable_behavior(self, mock_netbox_api):
        ...
        with patch("apscheduler.schedulers.background.BackgroundScheduler"):
            with patch("netbox_pdns.MQTTService") as mqtt_mock:
                ...
                mqtt_instance.get_status = Mock(return_value={
                    "enabled": True,
                    "connected": False,
    ...
    def test_api_endpoints_work_regardless_of_mqtt_config(self, mock_netbox_api):
    ...
    def test_configuration_validation_integration(self):
        ...
        with patch("netbox_pdns.NetboxPDNS") as mock_netbox:
            ...
            with pytest.raises(Exception):  # Should raise ValidationError during Settings creation
    ...
    def test_mqtt_status_endpoint_authentication(self):
